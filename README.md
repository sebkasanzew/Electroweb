...
### An app that lets you control your Philips Hue lamps and bind their color to your PCs live hardware data
...
Using the [Electron](http://electron.atom.io/) application boilerplate from C. T. Lin ([chentsulin/electron-react-boilerplate](https://github.com/chentsulin/electron-react-boilerplate)) based on [React](https://facebook.github.io/react/), [Redux](https://github.com/reactjs/redux), [React Router](https://github.com/reactjs/react-router), [Webpack](http://webpack.github.io/docs/), [React Transform HMR](https://github.com/gaearon/react-transform-hmr).
...
```bash
git clone https://github.com/sebkasanzew/Electroweb Electroweb
```
...
## How to keep the project up to date with the boilerplate

Add this repo to another git remote:
...
## License
MIT © [Sebastian Kasanzew](https://github.com/sebkasanzew)
